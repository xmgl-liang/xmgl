...
func InitApiServer() (err error) {
	...
	//letter_box
	mux.HandleFunc("/job/letter_box1", SearchFris)
	mux.HandleFunc("/job/letter_box2", SearchLetsOld)
	mux.HandleFunc("/job/letter_box3", HandleReplyLetter)
	mux.HandleFunc("/job/letter_box4", HandleDelFri)
