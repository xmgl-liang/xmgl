...
func InitApiServer() (err error) {
	...
	//wall
	mux.HandleFunc("/job/administrator1", HandleListLettersByWallType)
	mux.HandleFunc("/job/administrator2", HandleJobKill)
	mux.HandleFunc("/job/administrator3", SearchLetter)
	mux.HandleFunc("/job/administrator4/log", HandleJobLog)
	mux.HandleFunc("/job/administrator5/workerList", HandleWorkerList)
